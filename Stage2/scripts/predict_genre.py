...
saved_model_path = "../../Stage1/results/genre_PRCNN-0804/saved_model"
test_data_path = "../real-world-dataset/json_files/yt-link.json"
model_saved_mfcc = "../../Stage1/audio_file/preprocessed/310genre_dataset.json"
output_dir = "../results/1008-radar-10genres"  # Directory to save individual radar chart images
