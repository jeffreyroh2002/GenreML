...
HM_NAME = "1d_heatmap.png"
A_PLOT_NAME = '1d_accuracy.png'
L_PLOT_NAME = '1d_loss.png'
...
def Parallel_CNN_RNN(input_shape):
    ...
    C_layer1 = keras.layers.Conv1D(filters=16, kernel_size=3, activation='relu', padding='same')(input)
    C_layer1 = keras.layers.BatchNormalization()(C_layer1)
    C_layer1 = keras.layers.Dropout(0.2)(C_layer1)
    C_layer2 = keras.layers.MaxPooling1D(pool_size=2)(C_layer1)
    
    C_layer3 = keras.layers.Conv1D(filters=32, kernel_size=3, activation='relu', padding='same')(C_layer2)
    C_layer3 = keras.layers.BatchNormalization()(C_layer3)
    C_layer3 = keras.layers.Dropout(0.2)(C_layer3)
    C_layer4 = keras.layers.MaxPooling1D(pool_size=2)(C_layer3)
    
    C_layer5 = keras.layers.Conv1D(filters=64, kernel_size=3, activation='relu', padding='same')(C_layer4)
    C_layer5 = keras.layers.BatchNormalization()(C_layer5)
    C_layer5 = keras.layers.Dropout(0.2)(C_layer5)
    C_layer6 = keras.layers.MaxPooling1D(pool_size=2)(C_layer5)
    
    C_layer7 = keras.layers.Conv1D(filters=128, kernel_size=3, activation='relu', padding='same')(C_layer6)
    C_layer7 = keras.layers.BatchNormalization()(C_layer7)
    C_layer7 = keras.layers.Dropout(0.2)(C_layer7)
    C_layer8 = keras.layers.MaxPooling1D(pool_size=2)(C_layer7)
    
    C_layer9 = keras.layers.Conv1D(filters=64, kernel_size=3, activation='relu', padding='same')(C_layer8)
    C_layer9 = keras.layers.BatchNormalization()(C_layer9)
    C_layer9 = keras.layers.Dropout(0.2)(C_layer9)
    C_layer10 = keras.layers.MaxPooling1D(pool_size=2)(C_layer9)
    C_layer11 = keras.layers.Flatten()(C_layer10)
    
    R_layer1 = keras.layers.MaxPooling1D(pool_size=2)(input)
    ...
    R_layer3 = keras.layers.Dense(128, activation='relu')(R_layer1)
...
if __name__ == "__main__":
    ...
    input_shape = (X_train.shape[1], X_train.shape[2]) # Assumes input audiofeatures of shape (num_timesteps, num_features)
