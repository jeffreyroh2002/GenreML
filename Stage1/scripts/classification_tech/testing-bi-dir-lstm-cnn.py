...
def create_combined_model(cnn_input_shape, rnn_input_shape, num_classes, hidden_size):
    ...
    rnn_model = keras.layers.Bidirectional(keras.layers.LSTM(units=hidden_size, return_sequences=True))(rnn_input)
    rnn_model = keras.layers.Bidirectional(keras.layers.LSTM(units=hidden_size))(rnn_model)
