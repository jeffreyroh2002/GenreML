...
def Parallel_CNN_RNN(input_shape):
    ...
    C_layer = keras.layers.BatchNormalization()(C_layer)
    C_layer = keras.layers.Dropout(0.2)(C_layer)
    C_layer = keras.layers.MaxPooling2D(pool_size=(4,4), strides=(4,4))(C_layer)
    ...
    R_layer = keras.layers.MaxPooling2D(pool_size=(1,2), strides=(1,2))(input)
    # R_layer = keras.layers.MaxPooling2D(pool_size=(1,2), strides=(1,2))(R_layer)
    R_layer = keras.layers.Reshape(target_shape=(128,256))(R_layer)
