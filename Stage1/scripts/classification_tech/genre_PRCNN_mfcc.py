...
DATA_PATH = "/workspace/MusicML/Stage1/audio_file/preprocessed/310genre_dataset.json"
SAVE_MODEL = True
SAVE_HM = True

#OUTPUT DIR/FILE NAMES
NEWDIR_PATH = "genre_PRCNN-0804"
...
def Parallel_CNN_RNN(input_shape, num_classes):
    ...
    # C_layer8 = keras.layers.MaxPooling2D(pool_size=(2,2), strides=(2,2))(C_layer7)
    ...
    # C_layer10 = keras.layers.MaxPooling2D(pool_size=(2,2), strides=(2,2))(C_layer9)
    C_layer11 = keras.layers.Flatten()(C_layer6)
    
    # R_layer1 = keras.layers.MaxPooling2D(pool_size=(1,1), strides=(1,2))(input)
    ...
    R_layer4 = keras.layers.Bidirectional(keras.layers.GRU(512, return_sequences=True))(R_layer3)
    R_layer4 = keras.layers.BatchNormalization()(R_layer4)
    R_layer4 = keras.layers.Dropout(0.5)(R_layer4)
    R_layer4 = keras.layers.Bidirectional(keras.layers.GRU(512, return_sequences=False))(R_layer4)
    R_layer4 = keras.layers.BatchNormalization()(R_layer4)
    R_layer4 = keras.layers.Dropout(0.5)(R_layer4)
